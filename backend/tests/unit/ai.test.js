...
describe("AI Unit Tests", () => {
  ...
  describe("AI Generation", () => {
    it("should generate questions successfully", async () => {
      ...
      const result = await generateWithAI("Generate a math question", {
        max_tokens: 1000,
      });
    ...
    it("should handle AI generation failure", async () => {
      ...
      const result = await generateWithAI("Generate a question", {
        max_tokens: 1000,
      });
  ...
  describe("AI Log Tracking", () => {
    ...
    it("should mark log as success", async () => {
      ...
      expect(mockLog.markSuccess).toHaveBeenCalledWith(
        "response",
        100,
        200,
        1500,
    ...
    it("should mark log as failed", async () => {
      ...
      expect(mockLog.markFailed).toHaveBeenCalledWith(
